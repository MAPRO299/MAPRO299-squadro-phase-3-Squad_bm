...
class SquadroInterface:
    ...
    def vérification(self, joueur_1, joueur_2):
        ...
        Returns:
            List: L'état actuel du jeu sous la forme d'une liste de deux dictionnaires.
                  ...
                  Notez que les jetons doivent être sous forme de liste [x1, x2, x3, x4, x5] uniquement.
        Raises:
    ...
    def état_jeu(self):
        ...
        Examples:
            ...
            le premier jeton du joueur (de haut en bas pour le joueur 1, et de gauche à droite pour le joueur 2).
            L'entier assigné au jeton représente sa position (0 pour le départ, 6 pour la mi-chemin et 12 pour la fin).
        """
